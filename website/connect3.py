...
if appropriate_age(filename) == True:
    ...
    if age(filename) >= 19:
        if "Influenza" not in vaccine_name or flu_date == 0:  # we should go off the vax name used in the headers
            results_file.write("The CDC recommends that adults get 1 dose of the flu vaccine anually. Please consult with your physician or local pharmacy to schedule your flu dose.\n")
    ...
    results_file.write(" \n")
    results_file.write("Haemophiliacs influenza\n")
    results_file.write(" \n")
    ...
    results_file.write(" \n")
    results_file.write("Human papillomavirus\n")
    results_file.write(" \n")
    ...
    if age(filename) < 50:
        if most_recent_rzv_dose == 0:
            results_file.write("This vaccine is recommended for adults under 50 if they have an immunocompromising condition. If you believe this may apply to you, please consult with your physician to discuss eligibility.\n")
    ...
    if age(filename) < 65:
        if most_recent_mmr_dose == 0:
            results_file.write("1 to 2 doses of the MMR vaccine are needed to be considered fully vaccined. Records indicate you have not received an MMR vaccine. Please consult with your physician to discuss vaccination.\n")
